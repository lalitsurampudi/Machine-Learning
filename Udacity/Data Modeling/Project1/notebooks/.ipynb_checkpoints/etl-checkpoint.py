...
def process_song_file(cur, filepath):
    """
    Extract, transform and load 'song' data files in JSON format into 'song' and 'artist' tables
    """
    # open song file
...
def process_log_file(cur, filepath):
    """
    Extract, transform and load 'log' data files in JSON format into 'time', 'user' and 'songplays' tables
    """
    # open log file
    df = pd.read_json(filepath, lines=True)
